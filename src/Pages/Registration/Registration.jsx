      ...
      <div
        ...
        <div className="relative flex flex-col rounded-xl bg-slate-900 dark:bg-green-300 text-yellow-100 dark:text-slate-900    shadow-md">
          <div className= "rounded-t-xl">
            <h3 className="text-7xl font-semibold text-center mt-3 tracking-normal">
              Sign Up
            </h3>
          </div>
          <form
          ...
          >
            ...
            <div className="inline-flex items-center">
              ...
              <label
                className="mt-px cursor-pointer select-none text-yellow-100 dark:text-slate-100"
                htmlFor="checkbox"
              >
                <p className="flex items-center text-sm font-normal leading-normal text-yellow-100 dark:text-slate-900 antialiased">
                  I agree the
                  <a
