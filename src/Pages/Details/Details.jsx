...
const Details = () => {
  ...
  return (
    <div className="py-8">
      <Helmet>
        <title>Fashion Den | Details</title>
      </Helmet>
      <h1 className="text-center font-semibold text-2xl dark:text-green-300 mb-5">
        {details.name}
      </h1>
      <div>
          ...
          <div className="card-body">
            <div>
              <h5 className="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">
                Brand Name:{" "}
                <span className="text-blue-500 uppercase">{details.brand}</span>
              </h5>
              ...
              <h5 className="text-lg font-semibold tracking-tight text-gray-900 dark:text-white">
                Price :{" "}
                <span className="text-slate-900 bg-green-300 px-2 py-1 rounded-md">
                  {details.price}
                </span>
              </h5>
              <h5 className="flex items-center text-lg font-semibold tracking-tight text-gray-900 dark:text-white">
                Ratings :{" "}
                <span className="text-slate-900 ml-2">{details.rating}</span>{" "}
            ...
            <div className="h-32">
              <h5 className=" text-lg font-semibold tracking-tight text-gray-900 dark:text-white">
                Descriptions :{" "}
                <span className="text-slate-900 ml-2 dark:text-white">
                  {details.description}
                </span>
              </h5>
            </div>
